    ...
    $deployname="XeroxDemo1"
    $storageRGName="XeroxDemo1Store"
    $RGName="XeroxDemo1"
    $locName="Central US"
    $templateURI="https://raw.githubusercontent.com/agerasimchikeg/AzureTemplate/master/XeroxDemo1.json"

    ### Deleting Resource Group ###
    Remove-AzureRMResourceGroup -Name $RGName -Force

    ### Save the destination storage account key ###
    $destStorageKey = (Get-AzureRmStorageAccountKey -Name "xeroxdemo1ssd" -ResourceGroupName $storageRGName ).key1
    ...
    $destStorageAccount = "xeroxdemo1ssd"
    ...
    $subject = "XeroxDemo1 Deployment Results"
