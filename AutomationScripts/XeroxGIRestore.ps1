    ...
    $deployname="XeroxGI"
    $storageRGName="XeroxGIStore"
    $RGName="XeroxGI"
    $locName="Central US"
    $templateURI="https://raw.githubusercontent.com/eGistics/AzureTemplates/master/ConfigurationTemplates/XeroxGI.json"

    ### Deleting Resource Group ###
    Remove-AzureRMResourceGroup -Name $RGName -Force

    ### Save the destination storage account key ###
    $destStorageKey = (Get-AzureRmStorageAccountKey -Name "xeroxgistore" -ResourceGroupName $storageRGName ).key1
    ...
    $destStorageAccount = "xeroxgistore"
    ...
    $subject = "XeroxGI Restore Results"
