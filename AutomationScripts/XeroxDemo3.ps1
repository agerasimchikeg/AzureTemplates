 ### Get starting date/time ###
    ...
    $deployname="xeroxdemo3"
    $storageRGName="XeroxDemo3Store"
    $RGName="XeroxDemo3"
    $locName="Central US"
    ...
    $destStorageKey = (Get-AzureRmStorageAccountKey -Name "xeroxdemo3ssd" -ResourceGroupName $storageRGName ).key1
    ...
    $destStorageAccount = "xeroxdemo3ssd"
    ...
    $params = @{"vmName"=$deployname;"osDiskVhdUri"="https://xeroxdemo3ssd.blob.core.windows.net/vhds/XeroxDemo.vhd";"osType"="Windows";"vmSize"="Standard_F4s";}
    ...
    $subject = "XeroxDemo3 Deployment Results"
